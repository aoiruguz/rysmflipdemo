...
/// <summary>
/// 发射物体的淡出控制脚本（自动添加到发射的物体上）
/// </summary>
public class ProjectileFadeOut : MonoBehaviour
{
    [HideInInspector] public string fadeOutTriggerTag = "Wall";
    [HideInInspector] public float quickFadeDuration = 0.3f;
    [HideInInspector] public bool destroyOnFadeOut = true;
